...
export async function KaboomBetolto(mentes_id) {
  ...
  console.log("x:"+window.innerWidth+" y:"+window.innerHeight);
    ...
    k.loadSprite("Mitteous_Plateau_Collapsing_ground", "../../images/maps/Mitteous_Plateau_COLLAPSE_GROUND.png");
    ...
    k.loadSprite("Prowl", "../../images/sprites/Main_player.png", { //Ez még csak definiálás, majd le kell programozni a többi cuccot
        sliceX: 12,
        sliceY: 7,
        animations: {
            idle: { from: 0, to: 7, loop: true },
